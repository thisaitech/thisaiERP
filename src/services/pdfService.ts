...
export function generateInvoicePDF(data: InvoicePDFData): jsPDF {
  ...
  doc.text('Generated by ThisAI ERP | GST Compliant Invoice', pageWidth / 2, pageHeight - 6, { align: 'center' })
...
export function downloadEInvoicePDF(einvoiceData: any) {
  ...
  doc.setFontSize(8)
  doc.setFont('helvetica', 'bold')
  doc.text(einvoiceData.companyName || 'ThisAI ERP', col1, y)
  ...
  doc.text('Generated via ThisAI ERP - GST E-Invoice Compliant Software', pageWidth / 2, 287, { align: 'center' })
...
export async function downloadEWayBillPDF(ewayData: any) {
  ...
  doc.setFontSize(8)
  doc.setFont('helvetica', 'bold')
  doc.text(ewayData.companyName || 'ThisAI ERP', col1, y)
  ...
  doc.text('Generated via ThisAI ERP - GST Compliant Billing Software', pageWidth / 2, 287, { align: 'center' })
